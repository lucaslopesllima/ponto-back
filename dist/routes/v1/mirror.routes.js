...
const querySchema = z
    ...
    .refine((q) => (q.from != null && q.to != null) || (q.year != null && q.month != null), { message: 'Informe from e to, ou year e month' })
    .refine((q) => !(q.from && q.to) || q.from <= q.to, {
    message: 'Data início deve ser anterior ou igual à data fim',
});
export async function mirrorRoutes(app) {
    app.get('/mirror', { preHandler: [authenticate] }, async (request, reply) => {
...
//# sourceMappingURL=mirror.routes.js.map
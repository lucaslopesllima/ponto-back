...
import { AdjustmentModel, AdjustmentStatus, } from '../models/adjustment.model.js';
...
export async function createAdjustmentRequest(userId, input) {
...
export async function decideAdjustment(adminId, adjustmentId, approve) {
